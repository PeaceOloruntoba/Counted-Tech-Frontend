        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center mt-2">
                    <a href="{{ route('dashboard') }}">
                        <img src="./assets/logo.png" alt="" class="h-25 w-24 mt-3 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="flex flex-row">
                            <div class="mr-4 mt-4 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3">
            <ul class="flex flex-col space-y-2 mt-4">
                <li class="mr-4 ml-10 pt-2 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    <a class="flex items-center" href="#">
                        <img src="./assets/icon1.png" alt="" class="h-10 w-10">
                    </a>
                </li>
                <li class="mr-4 ml-10 pt-2 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    <a class="flex items-center" href="#">
                        <img src="./assets/icon2.png" alt="" class="h-10 w-10">
                    </a>
                </li>
                <li class="mr-4 ml-10 pt-2 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    <a class="flex items-center" href="#">
                        <img src="./assets/icon3.png" alt="" class="h-10 w-10">
                    </a>
                </li>
                <li class="mr-4 ml-10 pt-2 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    <a class="flex items-center" href="#">
                        <img src="./assets/icon4.png" alt="" class="h-10 w-10">
                    </a>
                </li>
                <li class="mr-4 ml-10 pt-2 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    <a class="flex items-center" href="#">
                        <img src="./assets/icon5.png" alt="" class="h-10 w-10">
                    </a>
                </li>
                <li class="mr-4 ml-10 pt-2 pb-3 transition-all duration-2000 ease-in-out hover:transform hover:scale-125">
                    <a class="flex items-center" href="#">
                        <img src="./assets/icon6.png" alt="" class="h-10 w-10">
                    </a>
                </li>
            </ul>
        </div>
